...
public class Object_Interact : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        targetObject = GameObject.Find("Player_Third_Person_PartyMale");
    ...
    void Examine()
    {
        ...
        {
            //This offsets the position of the 3D Model
    ...
    void NonExamine()
    {
        if (examinedObject != null)
        {
            ...
            {
                examinedObject.position =
                    Vector3.Lerp(examinedObject.position, originalPositions[examinedObject], 0.2f);
            }

            if (originalRotations.ContainsKey(examinedObject))
            {
                examinedObject.rotation =
                    Quaternion.Slerp(examinedObject.rotation, originalRotations[examinedObject], 0.2f);
            }
        }
    }
