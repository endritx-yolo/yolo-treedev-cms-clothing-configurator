...
namespace TriLibCore.Samples
{
    ...
    public class LoadModelFromURLSample : MonoBehaviour
    {
        ...
        /// The Model URL.
        /// </summary>
        /// https://ricardoreis.net/trilib/demos/sample/TriLibSampleModel.zip
        //public string ModelURL = "https://ricardoreis.net/trilib/demos/sample/TriLibSampleModel.zip";
        public string ModelURL = "https://yolocms-api.workatbambus.com/storage/uploads//TIf5H4IoU03wOJLpa0Nd.zip";
